    ...
    return(
        <footer className="w-full grid gap-20 grid-cols-3 bg-stone-900  text-neutral-400">
            ...
            <div className="flex gap-4">
                ...
                <button className="bg-green-400 transition-colors cursor-pointer duration-300  social-icons hover:bg-green-700 rounded-full  text-neutral-50">
            ...
            <div className="col-span-3 border-separate bg-amber-50">

            </div>
            <div className="">
                © 2026 Tienda de Gorras, Inc. Todos los derechos reservados.
            </div>
            <div className="col-span-2">
                Pagina creada por Jeronimo Perez, usando TailwindCSS y React con typescript para el frontend, nodeJS y Mongo para el backend.
            </div>
        </footer>
    )
}
